...
/* ===== hero ===== */
header{padding:42px 0 6px;text-align:center}
.avatar-wrap{position:relative;width:132px;margin:0 auto 18px}
...
.handle{font-family:"Caveat Brush","Nunito",cursive;font-size:1.35rem;color:var(--clay);margin-top:2px}
.tagline{margin-top:12px;color:var(--ink-soft);font-size:1.02rem;max-width:34ch;margin-inline:auto}
...
.big-cta{
  ...
  box-shadow:6px 6px 0 var(--shadow);padding:16px 18px;transform:rotate(-.6deg);
...
.big-cta .kicker{font-family:"Caveat Brush","Nunito",cursive;font-size:1.15rem;color:var(--clay);line-height:1.1;display:block}
.big-cta .name{font-family:"Gluten","Nunito",system-ui,sans-serif;font-weight:800;font-size:1.35rem;line-height:1.12;display:block;margin:2px 0 4px}
.big-cta .sub{display:block;font-size:.87rem;color:var(--ink-soft);line-height:1.35}
...
.link{display:flex;align-items:center;gap:14px;padding:14px 16px;text-decoration:none;transition:transform .16s ease,box-shadow .16s ease}
...
.link .ico{flex:0 0 44px;height:44px;border-radius:12px;border:2.5px solid var(--line);display:grid;place-items:center;
  font-family:"Gluten","Nunito",system-ui,sans-serif;font-weight:800;font-size:1.1rem;color:#38222B}
.link .txt{flex:1;min-width:0;display:block}
.link .name{display:block;font-family:"Gluten","Nunito",system-ui,sans-serif;font-weight:700;font-size:1.05rem;line-height:1.25}
.link .desc{display:block;font-size:.85rem;color:var(--ink-soft);line-height:1.35;margin-top:1px}
.link .arrow{font-size:1.25rem;color:var(--ink-soft);flex:0 0 auto}
...
.gal-note{font-family:"Caveat Brush","Nunito",cursive;font-size:1.1rem;color:var(--ink-soft);text-align:center;margin-top:10px}
